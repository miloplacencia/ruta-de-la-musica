...
const MenuMapa = ({ seccion, cambiarSeccion }) => (
  <div className="rm-mapa__menu">
    <ul className="rm-mapa__menu-nav">
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('musica-en-vivo')}
          className={seccion === 'musica-en-vivo' ? 'activo' : ''}
        >
          ...
          <strong>Música en vivo</strong>
        </a>
      </li>
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('pubs-discoteques')}
          className={seccion === 'pubs-discoteques' ? 'activo' : ''}
        >
          ...
          <strong>Pubs y discoteques</strong>
        </a>
      </li>
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('bares-restaurantes')}
          className={seccion === 'bares-restaurantes' ? 'activo' : ''}
        >
          ...
          <strong>Bares y restaurantes</strong>
        </a>
      </li>
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('tiendas-escuelas-musica')}
          className={seccion === 'tiendas-escuelas-musica' ? 'activo' : ''}
        >
          ...
          <strong>Tiendas y escuelas de música</strong>
        </a>
      </li>
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('hitos-musicales')}
          className={seccion === 'hitos-musicales' ? 'activo' : ''}
        >
          <svg width="26" height="26" viewBox="0 0 12 14">
            <path
              fillRule="evenodd"
          ...
          <strong>Hitos musicales</strong>
        </a>
      </li>
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('espacios')}
          className={seccion === 'espacios' ? 'activo' : ''}
        >
      ...
      <li>
        <a
          href="#"
          onClick={cambiarSeccion('comer-dormir')}
          className={seccion === 'comer-dormir' ? 'activo' : ''}
        >
          ...
          <strong>Dónde comer y dormir</strong>
        </a>
      </li>
      <li>
        <a href="#">
